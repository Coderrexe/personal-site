    ...
    <div className="max-w-[60rem] mx-auto px-6">
      ...
      <section className="pt-24 pb-20">
        ...
        <AnimatedBio paragraphs={[
          ...
          "My current research is in machine learning and robotics, spanning multimodal foundation models, mechanistic interpretability, generalist robot policies, and I'm interested broadly in intelligence in both its digital and biological forms.",

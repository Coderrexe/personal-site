    ...
    <div className="max-w-[60rem] mx-auto px-8 sm:px-10">
      ...
      <FadeIn>
        <section className="pt-20 sm:pt-24 pb-10 sm:pb-14">
          <h1 className="font-serif text-[1.9rem] sm:text-[2.2rem] text-fg tracking-[-0.02em] leading-tight">Work</h1>
        </section>
      </FadeIn>
            ...
            <section className="pt-5 pb-16">
              ...
              <div className="circuit-list">
                {visibleWork.map((item, idx) => (
                  <article
                    key={item.company}
                    className="circuit-row tilt-row relative py-6 sm:py-8 -mx-3 px-3 rounded-lg border-b border-line last:border-0 cursor-default"
          ...
          <section className="pt-4 pb-24" id="research">
            ...
            <div className="circuit-list">
              {visibleResearch.map((item, idx) => (
                <article key={idx} className="circuit-row tilt-row relative py-6 sm:py-8 -mx-3 px-3 rounded-lg border-b border-line last:border-0">
                  <span className="circuit-node circuit-node-lg" />
                  <div className="flex flex-wrap items-start gap-x-6 gap-y-1 justify-between mb-2">

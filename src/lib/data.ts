...
export const workItems: WorkItem[] = [
  {
    company: "Tractable",
    role: "ML Intern",
    tagline: "Building ML models and infra for insurance at one of UK's top computer vision unicorns.",
    period: "May 2026 – Present",
    note: "Series E, $1B valuation",
    location: "London, UK",
    description: [
      "• Building ML models and infra for insurance. More to come soon.",
      "• UK's top unicorn startup in computer vision.",
    ],
    links: [
